...
public class Failedlogin1Test {
  ...
  public void failedlogin1() {
    ...
    driver.findElement(By.id("sign-in__password")).sendKeys("fEhCJi");
    driver.findElement(By.cssSelector(".sign-in-form")).click();
    driver.findElement(By.cssSelector(".alert__heading")).isDisplayed();//or alert__inner
  }
}
