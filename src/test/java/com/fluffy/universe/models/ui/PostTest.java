...
public class PostTest {
  ...
  public void post() {
    ...
    driver.findElement(By.cssSelector(".post-form__title")).click();
    {
      ...
      js.executeScript("if(arguments[0].contentEditable === 'true') {arguments[0].innerText = 'fhdh'}", element);
    }
    driver.findElement(By.cssSelector(".post-form__description")).click();
    {
      ...
      js.executeScript("if(arguments[0].contentEditable === 'true') {arguments[0].innerText = 'fhdfhd'}", element);
    }
    ...
    driver.findElement(By.xpath("/html/body/main/div/div[1]/div[1]/div[1]/h2[text()='fhdh']"+"")).isDisplayed();
